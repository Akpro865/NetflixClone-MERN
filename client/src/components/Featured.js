  ...
  return (
  	<div className='featured relative mb-3'>
	    ...
	    <div className='w-4/12 absolute left-8 bottom-10 flex flex-col'>
	     	...
	     	<span className='text-white text-semibold mx-4'>img elements must have an alt prop, either with meaningful text, or an empty string for decorative images
	     	img elements must have an alt prop, either with meaningful text, or an empty string for decorative images
	     	</span>
	     	<div className='text-lg mt-4 flex'>
	     		<button className='bg-white p-3 rounded ml-4'>
	     			<PlayArrowOutlinedIcon />
	     			<span className='ml-2'>Play</span>
	     		</button>
	     		<button className='p-3 rounded bg-gray-300 ml-6'>
	     			<InfoOutlinedIcon />
