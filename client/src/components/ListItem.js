  	 ...
  	 className='listItem h-32 w-56 cursor-pointer bg-white mr-1 rounded overflow-hidden hover:w-80 hover:h-76 hover:absolute hover:-top-32'>
		...
		<div className='flex flex-col p-2'>
			<div className='text-white flex mr-2 text-2xl font-bold'>
				<PlayArrowIcon className='border-2 rounded-full mr-2 p-1 hover:bg-gray-400 hover:text-black'/>
				<AddIcon className='border-2 rounded-full mr-2 p-1 hover:bg-gray-400 hover:text-black'/>
				<ThumbUpOutlinedIcon className='border-2 rounded-full mr-2 p-1 hover:bg-gray-400 hover:text-black'/>
				<ThumbDownOutlinedIcon className='border-2 rounded-full mr-2 p-1 hover:bg-gray-400 hover:text-black'/>
			</div>
